...
lbl_min=Label(root,text="12",font=("times new roman",50,"bold"),bg="red",fg="white")
lbl_min.place(x=520,y=200,width=150,height=150)
lbl_min2=Label(root,text="MINUTE",font=("times new roman",20,"bold"),bg="red",fg="white")
lbl_min2.place(x=520,y=360,width=150,height=50)

lbl_sec=Label(root,text="12",font=("times new roman",50,"bold"),bg="purple",fg="white")
lbl_sec.place(x=690,y=200,width=150,height=150)
lbl_sec2=Label(root,text="SECOND",font=("times new roman",20,"bold"),bg="purple",fg="white")
